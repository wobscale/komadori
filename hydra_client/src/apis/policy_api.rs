...
pub trait PolicyApi {
    fn create_policy(&self, body: ::models::Policy) -> Box<Future<Item = ::models::Policy, Error = Error<serde_json::Value>>>;
    ...
    fn update_policy(&self, id: &str, body: ::models::Policy) -> Box<Future<Item = ::models::Policy, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>PolicyApi for PolicyApiClient<C> {
    fn create_policy(&self, body: ::models::Policy) -> Box<Future<Item = ::models::Policy, Error = Error<serde_json::Value>>> {
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<::models::Policy, _> = serde_json::from_slice(&body);
    ...
    fn list_policies(&self, offset: i64, limit: i64) -> Box<Future<Item = Vec<::models::Policy>, Error = Error<serde_json::Value>>> {
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<Vec<::models::Policy>, _> = serde_json::from_slice(&body);
                parsed.map_err(|e| Error::from(e))
            })
        )
    }
