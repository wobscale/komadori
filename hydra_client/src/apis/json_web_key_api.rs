...
pub trait JsonWebKeyApi {
    fn create_json_web_key_set(&self, set: &str, body: ::models::JsonWebKeySetGeneratorRequest) -> Box<Future<Item = ::models::JsonWebKeySet, Error = Error<serde_json::Value>>>;
    ...
    fn update_json_web_key(&self, kid: &str, set: &str, body: ::models::JsonWebKey) -> Box<Future<Item = ::models::JsonWebKey, Error = Error<serde_json::Value>>>;
    fn update_json_web_key_set(&self, set: &str, body: ::models::JsonWebKeySet) -> Box<Future<Item = ::models::JsonWebKeySet, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>JsonWebKeyApi for JsonWebKeyApiClient<C> {
    ...
    fn update_json_web_key(&self, kid: &str, set: &str, body: ::models::JsonWebKey) -> Box<Future<Item = ::models::JsonWebKey, Error = Error<serde_json::Value>>> {
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<::models::JsonWebKey, _> = serde_json::from_slice(&body);
                parsed.map_err(|e| Error::from(e))
            })
        )
    }
