...
impl InlineResponse2001 {
  ...
  pub fn with_access_token(mut self, access_token: String) -> InlineResponse2001 {
    self.access_token = Some(access_token);
    self
  }
  ...
  pub fn with_expires_in(mut self, expires_in: i64) -> InlineResponse2001 {
    self.expires_in = Some(expires_in);
    self
  }
  ...
  pub fn with_id_token(mut self, id_token: i64) -> InlineResponse2001 {
    self.id_token = Some(id_token);
    self
  }
  ...
  pub fn with_refresh_token(mut self, refresh_token: String) -> InlineResponse2001 {
    self.refresh_token = Some(refresh_token);
    self
  }
  ...
  pub fn with_scope(mut self, scope: i64) -> InlineResponse2001 {
    self.scope = Some(scope);
    self
  }
  ...
  pub fn with_token_type(mut self, token_type: String) -> InlineResponse2001 {
    self.token_type = Some(token_type);
    self
  }
