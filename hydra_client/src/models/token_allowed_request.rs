...
pub struct TokenAllowedRequest {
...
impl TokenAllowedRequest {
  pub fn new() -> TokenAllowedRequest {
    TokenAllowedRequest {
      action: None,
      context: None,
      resource: None
  ...
  pub fn with_action(mut self, action: String) -> TokenAllowedRequest {
    self.action = Some(action);
    self
  }
  ...
  pub fn with_context(mut self, context: ::std::collections::HashMap<String, Value>) -> TokenAllowedRequest {
    self.context = Some(context);
    self
  }
  ...
  pub fn with_resource(mut self, resource: String) -> TokenAllowedRequest {
    self.resource = Some(resource);
    self
  }
